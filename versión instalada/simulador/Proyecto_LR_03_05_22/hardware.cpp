...
//Declarando pines de entrada/salida
    ...
    //Pines de Salida digitales
          //Selección de Laser
            #define Laser_Verde 7 //A2 en nano 7 en uno
            #define Laser_Rojo  6
    ...
    switch(sel){
      ...
      case 'R':{
          //Enciendo Laser_Rojo/verde CUANDO INICIA EL ENSAYO
             if (*ptr_laser_sel == 1)digitalWrite(Laser_Rojo,1);// experimento A 
             else if (*ptr_laser_sel == 0)digitalWrite(Laser_Verde,1);// experimento B 
          //Envío de trama
